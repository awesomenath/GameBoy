...
{
    public class ComplementCarryFlag : BaseTest
    {

        [Test]
        public void TestComplementCarryFlag()
        {
            var opCode = new Core.Instructions.OpCodes.ComplementCarryFlag();
        ...
        [Test]
        public void TestComplementCarryFlag2()
        {
            var opCode = new Core.Instructions.OpCodes.ComplementCarryFlag();
